                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className='p-10 space-y-4 w-[500px]'>
                        <div className='flex gap-2'>
                            <div className='flex flex-col'>
                                ...
                                <input className='border-2 border-[#FF7703] p-2 bg-slate-100 rounded' type="text" {...register("name", { required: true })} name="name" id="" placeholder='Type your name' required />
                            </div>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <div className='flex relative'>
                                    <input className='border-2 border-[#FF7703] p-2 bg-slate-100 rounded w-[100%]' type={show ? 'text' : 'password'}  {...register("password", { required: true, minLength: 6, pattern: /(?=.*[A-Z])(?=.*[!@#$%^&*])/ })} name="password" id="" placeholder='Type your password' required />
                            ...
                            <div className='flex flex-col'>
                                ...
                                <div className='flex relative'>
                                    <input className='border-2 border-[#FF7703] p-2 bg-slate-100 rounded' type={show ? 'text' : 'password'} {...register("confirmPassword", { required: true })} name="confirmPassword" id="" placeholder='Confirm Password' required />
                                    <p onClick={() => setShow(!show)} className='p-3 ms-1 absolute right-0 top-1'>{
                        ...
                        <div className='flex flex-col'>
                            ...
                            <input className='border-2 border-[#FF7703] p-2 bg-slate-100 rounded' type="text" {...register("photo", { required: true })} name="photo" id="" placeholder='Photo URL' required />
                        </div>
                        ...
                        <div>
                            <p className=' text-[#FF7703] font-bold text-center'>Already have account? <Link className='hover:underline' to='/logIn'>LogIn</Link></p>
                        </div>
                    </form>
                </div>
            </div>
