                ...
                <ul className="menu p-4 w-80 h-full bg-[#FF7703] text-base-content">
                    ...
                    {isAdmin[1] == "admin" && (
                        <div className='space-y-3'>
                            ...
                            <li><NavLink to={'/dsfg'} className={({ isActive }) => (isActive ? 'text-text text-lg duration-300 font-bold ' : 'font-bold text-white  transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-300 me-5')}><FaBook className='w-5 h-5'></FaBook> Manage Classes</NavLink></li>
                    ...
                    {isAdmin[1] == "musician" && (
                        <div className='space-y-3'>
                            ...
                            <li><NavLink to={'/'} className={({ isActive }) => (isActive ? 'text-white  text-lg duration-300 font-bold ' : 'font-bold text-white   transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-300 me-5')}><FaBookMedical className='w-5 h-5'></FaBookMedical>Add a Class</NavLink></li>

                            <li><NavLink to={'/'} className={({ isActive }) => (isActive ? 'text-white  text-lg duration-300 font-bold hover:bg-yellow-300' : 'font-bold text-white  transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-300 me-5')}><FaSwatchbook className='w-5 h-5'></FaSwatchbook>My Classes</NavLink></li>
                        </div>
                    )}
