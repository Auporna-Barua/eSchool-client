                ...
                <ul className="menu p-4 w-80 h-full bg-[#FF7703] text-base-content">
                    ...
                    {isAdmin[1] == "student" && (
                        <div className='space-y-3'>
                            ...
                            <li><NavLink to={'/'} className={({ isActive }) => (isActive ? 'text-white  text-lg duration-300 font-bold ' : 'font-bold text-white transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-300 me-5')}><FaBookOpen className='w-5 h-5'></FaBookOpen> My Selected Classes</NavLink></li>

                            <li><NavLink to={'/'} className={({ isActive }) => (isActive ? 'text-white  text-lg duration-300 font-bold ' : 'font-bold text-white transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-300 me-5')}><FaBookReader className='w-5 h-5'></FaBookReader>My Enrolled Classes</NavLink></li>
                        </div>
                    )}
